export const merge = (knex, fromEstablishmentId, toEstablishmentId) => {
...
export const revertMerge = (knex, fromEstablishmentId, toEstablishmentId) => {
...
export default { merge, revertMerge };
